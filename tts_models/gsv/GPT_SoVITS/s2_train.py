...
import utils as utils, os
hps, args = utils.get_hparams(stage=2)
...
hps["train"]["epochs"] = int(args.epoch)
hps["train"]["text_low_lr_rate"] = 0.4
hps["train"]["pretrained_s2G"] = "checkpoints/GSV/base_models/gsv-v2final-pretrained/s2G2333k.pth"
hps["train"]["pretrained_s2D"] = "checkpoints/GSV/base_models/gsv-v2final-pretrained/s2D2333k.pth"
hps["train"]["if_save_latest"] = False
hps["train"]["if_save_every_weights"] = False
hps["train"]["save_every_epoch"] = int(args.save_interval)
hps["train"]["gpu_numbers"] = "0"
hps["model"]["version"] = version = "v2"
hps["data"]["exp_dir"] = s2_dir
hps["s2_ckpt_dir"] = "%s/%s/%s" % (s2_dir, "logs_s2", "tensorboards")
hps["save_weight_dir"] = "SoVITS_weights_v2"
hps["name"] = exp_name
hps["version"] = version
