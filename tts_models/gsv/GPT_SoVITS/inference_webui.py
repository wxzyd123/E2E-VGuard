...
pretrained_sovits_name=["checkpoints/GSV/base_models/gsv-v2final-pretrained/s2G2333k.pth", 
                        "checkpoints/GSV/base_models/s2G488k.pth"]
pretrained_gpt_name=["checkpoints/GSV/base_models/gsv-v2final-pretrained/s1bert25hz-5kh-longer-epoch=12-step=369668.ckpt", 
                     "checkpoints/GSV/base_models/s1bert25hz-2kh-longer-epoch=68e-step=50232.ckpt"]
...
with open(f"./weight.json", 'r', encoding="utf-8") as file:
    ...
    gpt_path = ["checkpoints/GSV/base_models/gsv-v2final-pretrained/s1bert25hz-5kh-longer-epoch=12-step=369668.ckpt"]
...
cnhubert_base_path = os.environ.get(
    "cnhubert_base_path", "checkpoints/GSV/base_models/chinese-hubert-base"
)
bert_path = os.environ.get(
    "bert_path", "checkpoints/GSV/base_models/chinese-roberta-wwm-ext-large"
)
...
from tts_models.gsv.GPT_SoVITS.text import cleaned_text_to_sequence
from tts_models.gsv.GPT_SoVITS.text.cleaner import clean_text
...
def change_sovits_weights(sovits_path,prompt_language=None,text_language=None):
    ...
    try:
        ...
        vq_model.load_state_dict(dict_s2["model"], strict=False)
    dict_language = dict_language_v1 if version =='v1' else dict_language_v2
...
from tts_models.gsv.GPT_SoVITS.text import chinese
...
SoVITS_weight_root=["tts_models/gsv/SoVITS_weights_v2","tts_models/gsv/SoVITS_weights"]
GPT_weight_root=["tts_models/gsv/GPT_weights_v2","tts_models/gsv/GPT_weights"]
