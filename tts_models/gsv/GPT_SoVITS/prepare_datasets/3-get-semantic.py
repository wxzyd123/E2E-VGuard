...
parser.add_argument("--inp_text", type=str, default="filelists/LibriTTS_train_GSV_clean.txt")
parser.add_argument("--inp_wav_dir", type=str, default="data/LibriTTS/protected/clean/")
parser.add_argument("--exp_name", type=str, default="clean")
args = parser.parse_args()

inp_text = args.inp_text
inp_wav_dir = args.inp_wav_dir
...
pretrained_s2G = "checkpoints/GSV/base_models/gsv-v2final-pretrained/s2G2333k.pth"
s2config_path = "tts_models/gsv/GPT_SoVITS/configs/s2.json"
is_half = False
version = "v2"
